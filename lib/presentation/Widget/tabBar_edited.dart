...
class UnderlineInputBorderE extends InputBorder {
  ...
  Path getInnerPath(Rect rect, { TextDirection? textDirection }) {
   ...
   // Rect.fromLTWH(tabLeft, tabBarSize.height - 4.0, tabRight - tabLeft, 4.0);
  @override
  ...
  void paint(
    ...
    final Gradient gradiant = new LinearGradient(colors: [Colors.transparent , Colors.white, Colors.transparent]);
    final shadow = Paint();
    shadow.shader = gradiant.createShader(rect);
    shadow.strokeWidth = 2;
    canvas.drawLine(rect.bottomLeft, rect.bottomRight, shadow);
